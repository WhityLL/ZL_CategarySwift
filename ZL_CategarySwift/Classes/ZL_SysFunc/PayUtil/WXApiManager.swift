...
public class WXApiManager: NSObject {
    public static let shared = WXApiManager()
    // 用于弹出警报视图，显示成功或失败的信息()
    ...
    //登录成功
    public var loginSuccessClosure:((_ code:String) -> Void)?
    //登录失败
    ...
    // 调起微信登录
    public func login(_ sender: UIViewController, loginSuccess: @escaping ( _ code:String) -> Void,
